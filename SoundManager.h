...
private:
	...
	static SoundManager* _pInstance; // Pointer to instance (SINGLETON)
...
public:
	...
	*/
	...
	/*
		Deletes a sound from the SoundManager map
	...
	*/
	...
	/*
		Gets the sound path given an ID sound
	...
	*/
	...
	/*
		Plays a sound from a certain point
		\param ID of the sound
		\param Number of loops, -1 to loop infinitely.
	...
	*/
	...
	/*
		Set the volume of the sound to a certain value
...
private:
	/*
		Loads from disc and adds a sound to the SoundManager
	...
	*/
	...
	/*
		Searches the first NULL in _soundsVector and updates _firstFreeSlot to store its position
	*/
